    ...
    public Iterable<ResultT> apply(
      ...
      if (valuesAndContPosition.continuationPosition == null) {
        ...
        if (stateTag.getMultimapKey() != null) {
          contStateTag = contStateTag.toBuilder().setMultimapKey(stateTag.getMultimapKey()).build();
        }
        if (stateTag.getOmitValues() != null) {
          contStateTag = contStateTag.toBuilder().setOmitValues(stateTag.getOmitValues()).build();
        }
